...
def main():
    ...
    print(now.strftime("L'année actuelle est : %Y"))
    ...
    print(f"Un an à partir d'aujourd'hui sera : {now + timedelta(days=1)}")

    # Créer un timedelta qui utilise plus d'un argument
    print(f"Dans deux semaines et 3 jours, il sera : {now + timedelta(weeks = 2, days = 3)}")
    ...
    # diff seconds n'affiche rien car les variables sont des dates et non des datetime
